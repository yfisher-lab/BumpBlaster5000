...
def build_cmd_str(queue):
    ...
    num_trials = int((t_bj+t_cl)/t_ttl) #number of trials (closed loop + 2 bar jumps); int() will round down to nearest integer
    ...
    # headings = [0,1023,2046,3070,4096]
    headings = headings[:-1] #remove 360' since 0 and 360 are the same.
